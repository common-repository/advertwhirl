...
$advertwhirl_plugin_name = "Advertwhirl";
$advertwhirl_plugin_version = "1.0.14b";

$advertwhirl_stats_name = "Advertwhirl_stats";
$advertwhirl_options_name = "Advertwhirl_options";
?>
